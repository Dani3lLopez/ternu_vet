...
public class ServicesModel {
    ...
    // dado un ID, devuelve los datos del servicio correspondiente
    ...
    // Dado un Id, actualiza los dados del servicio correspondinte
    public static int actualizarServicio(String id, String nombreServicio, String descripcionServicio,
