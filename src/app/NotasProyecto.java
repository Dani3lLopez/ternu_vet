...
public class NotasProyecto {
    ...
    * Vista: Simulación de front-end del proyecto (todo en consola).
    * Controlador: Capa de comunicación entre Modelo y Vista (Almacena atributos, getters-setters y otros métodos que ayudan al flujo de los datos)
    * MODELO:
    ...
    *   - Para instalar el JDBC deben buscar la opción: "Project Structure" en el menu del IDE
    *       ->MODULES
